(function () {
  ...
  var CSS = '.sidebar{position:fixed;inset:0 auto 0 0;width:230px;padding:24px 16px 20px;z-index:200;display:flex;flex-direction:column;overflow:hidden;color:#fff;background:linear-gradient(180deg,#07170f,#0b2116)}'
    ...
    + '.sb-nav{position:relative!important;top:auto!important;z-index:auto!important;display:flex!important;flex-direction:column;gap:3px;flex:1;align-items:stretch!important;justify-content:flex-start!important;background:transparent!important;backdrop-filter:none!important;border:none!important;padding:0!important;height:auto!important}'
    ...
    + '.sb-support{display:block;text-decoration:none;background:rgba(255,255,255,.035);border:1px solid rgba(255,255,255,.07);border-radius:10px;padding:11px 12px;font-size:11px;color:rgba(255,255,255,.42);line-height:1.5;overflow:hidden;transition:border-color .15s,color .15s}.sb-support:hover{border-color:rgba(255,255,255,.18);color:rgba(255,255,255,.6)}.sb-support strong{display:block;color:rgba(255,255,255,.75);margin-bottom:2px}'
    ...
    + '@media(max-width:760px){body{padding-top:58px;padding-bottom:86px}.sidebar,.app-sidebar{display:none!important}.app-header,.top-nav,body>nav{top:58px!important}.app-header,.top-nav{position:sticky!important;z-index:640!important;min-height:46px!important;height:auto!important;padding:0 14px!important}.app-header .nav-credits,.top-nav .nav-badge-pro,.top-nav .theme-btn,.top-nav .btn-analisar-top{display:none!important}.app-breadcrumb,.breadcrumb-nav{min-height:46px}.vagaai-mobile-ui{display:block}.vm-top{position:fixed;top:0;left:0;right:0;height:58px;z-index:650;display:flex;align-items:center;justify-content:space-between;padding:0 14px;background:rgba(245,247,245,.92);border-bottom:1px solid rgba(7,18,9,.08);backdrop-filter:blur(18px)}[data-theme="dark"] .vm-top{background:rgba(7,13,8,.9);border-color:rgba(255,255,255,.07)}.vm-menu-btn{width:40px;height:40px;border:1px solid rgba(26,122,74,.18);border-radius:12px;background:#fff;color:#07170f;display:grid;place-items:center;box-shadow:0 8px 24px rgba(7,18,9,.08)}[data-theme="dark"] .vm-menu-btn{background:#0d1610;color:#ddeae0}.vm-menu-btn svg{width:21px;height:21px}.vm-brand{display:flex;align-items:center;gap:8px;text-decoration:none;padding:7px 0}.vm-brand img:first-child{width:28px;height:28px;border-radius:8px}.vm-brand img:not(:first-child){height:30px;width:auto}.vm-wm-ondark{display:none}[data-theme="dark"] .vm-wm-onlight{display:none}[data-theme="dark"] .vm-wm-ondark{display:block}.vm-top-spacer{width:40px}.vm-overlay{position:fixed;inset:0;z-index:690;background:rgba(3,12,7,.52);backdrop-filter:blur(2px);opacity:0;pointer-events:none;transition:opacity .2s}.vm-drawer{position:fixed;z-index:700;top:0;bottom:0;left:0;width:min(82vw,310px);padding:22px 18px;background:#fff;border-radius:0 24px 24px 0;box-shadow:24px 0 70px rgba(0,0,0,.22);transform:translateX(-105%);transition:transform .24s cubic-bezier(.2,.8,.2,1);display:flex;flex-direction:column;overflow-y:auto;overscroll-behavior:contain}[data-theme="dark"] .vm-drawer{background:#07170f}.vm-open .vm-overlay{opacity:1;pointer-events:auto}.vm-open .vm-drawer{transform:translateX(0)}.vm-drawer-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:18px}.vm-drawer-logo{display:flex;align-items:center;gap:9px}.vm-drawer-logo img:first-child{width:30px;height:30px;border-radius:9px}.vm-drawer-logo img:not(:first-child){height:34px;width:auto}.vm-close{width:44px;height:44px;border:1px solid rgba(7,18,9,.09);border-radius:11px;background:#f5f7f5;color:#07170f;display:grid;place-items:center}[data-theme="dark"] .vm-close{background:#0d1610;color:#ddeae0;border-color:rgba(255,255,255,.1)}.vm-drawer-label{font-size:10px;font-weight:800;letter-spacing:.1em;text-transform:uppercase;color:#6d8877;margin:8px 4px 10px}.vm-drawer-nav{display:grid;gap:5px}.vm-drawer-btn{width:100%;border:0;border-radius:12px;background:transparent;color:#3d5c47;display:flex;align-items:center;gap:11px;padding:12px 11px;font:700 13px Manrope,system-ui;text-align:left}.vm-drawer-btn svg{width:18px;height:18px}.vm-drawer-btn.active{background:rgba(78,206,145,.14);color:#071209;box-shadow:inset 3px 0 0 #4ece91}[data-theme="dark"] .vm-drawer-btn{color:#8fb29a}[data-theme="dark"] .vm-drawer-btn.active{color:#fff}.vm-drawer-foot{margin-top:auto;padding-top:16px;border-top:1px solid rgba(7,18,9,.08);display:flex;align-items:center;gap:10px;color:#5d7a66}.vm-drawer-foot .sb-avatar{width:36px;height:36px}.vm-drawer-user strong{display:block;font-size:12px;color:#071209}.vm-drawer-user span{font-size:11px}[data-theme="dark"] .vm-drawer-user strong{color:#fff}.vm-bottom{position:fixed;left:10px;right:10px;bottom:calc(10px + env(safe-area-inset-bottom,0px));height:66px;z-index:660;background:#fff;border:1px solid rgba(7,18,9,.08);border-radius:24px;box-shadow:0 14px 44px rgba(7,18,9,.16);display:grid;grid-template-columns:repeat(5,1fr);overflow:hidden}[data-theme="dark"] .vm-bottom{background:#0d1610;border-color:rgba(255,255,255,.08)}.vm-bottom-btn{border:0;background:transparent;color:#6d8877;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;font:700 11px Manrope,system-ui;min-width:0}.vm-bottom-btn svg{width:20px;height:20px}.vm-bottom-btn.active{color:#fff;background:#0b2116}.vm-bottom-btn.active svg{color:#4ece91}.vm-bottom-btn[data-nav="app"]{font-weight:800}.vm-bottom-btn[data-nav="app"].active{background:linear-gradient(180deg,#0b2116,#103b25)}}';
  ...
  function buildHTML(opts) {
    ...
    return '<div id="vagaaiNavShell">'
      + '<aside class="sidebar" id="vagaaiSidebar" aria-label="Menu principal">'
        ...
        + '<div class="sb-bottom"><a class="sb-support" href="/blog" target="_blank" rel="noopener"><strong>Precisa de ajuda?</strong>' + (opts.supportText || 'Veja dicas para melhorar suas candidaturas.') + '</a>'
