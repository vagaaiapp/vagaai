...
const ENTITLEMENTS = {
  free: {
    ...
    // A conta gratuita recebe 1 análise completa a cada janela de 30 dias.
    // A disponibilidade corrente continua sendo calculada pelo backend, mas o
    // tamanho da franquia mora aqui como nos demais planos.
    analyses_limit: 1,
    letters_limit: 0,
    interviews_limit: 0,
    cv_otimizado: false,
