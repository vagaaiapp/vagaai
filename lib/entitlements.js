...
const ENTITLEMENTS = {
  ...
  starter: {
    plan: 'starter',
    alerts_enabled: true,
    // 1 até a Fase 2. job_alert_profiles tem PRIMARY KEY (user_id): o banco
    // guarda um perfil por conta, então anunciar 3 (ou ∞ no Pro) vendia um
    // recurso que não existe — o painel exibia "0 de ∞" e o botão "Criar novo
    // alerta" abria o editor do único perfil. A Fase 2 migra a PK para id e
    // sobe estes números junto com a copy da landing.
    max_active_alerts: 1,
  ...
  pro: {
    plan: 'pro',
    alerts_enabled: true,
    max_active_alerts: 1, // ver comentário no plano starter — Fase 2 libera
